          ...
          <div className="max-w-7xl mx-auto">
            ...
            <header className="mb-8 pt-6 text-white">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold mb-2">
                <span className="text-zinc-50 block">Warehouse Dashboard</span>
                <span className="bg-gradient-to-r from-violet-300 via-indigo-200 to-purple-300 bg-clip-text text-transparent">
                  Inventory & Distribution
                </span>
              </h1>
              <p className="text-zinc-300 mt-2">Monitor inventory, stock levels, and warehouse capacity across all locations</p>
            </header>
            ...
            {loading ? (
              ...
              <>
                {/* Update StatCard styles to match admin dashboard */}
                ...
                {showLowStockItems && (
                  <div className="bg-gradient-to-br from-white/80 to-white/40 dark:from-slate-800/80 dark:to-slate-800/40 backdrop-blur-xl rounded-2xl p-6 mb-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200/50 dark:border-slate-700/50">
                ...
                <div className="mt-8">
                  <h2 className="text-2xl font-bold text-slate-800 dark:text-white mb-4">All Warehouses</h2>
                  <div className="bg-gradient-to-br from-white/80 to-white/40 dark:from-slate-800/80 dark:to-slate-800/40 backdrop-blur-xl rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200/50 dark:border-slate-700/50">
                                ...
                                >
                                  ...
                                  <td className="py-4 px-6">
                                    <button
                                      ...
                                      className="px-3 py-1 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-md hover:shadow-md transition-all duration-300"
                                    >
                                      View Details
                                    </button>
                                  </td>
...
// Update StatCard component to match admin dashboard style
const StatCard = ({ title, value, change, isPositive, icon, delay, animate, color, onClick }) => {
  ...
  return (
    <div 
      ...
      } ${isHovered ? "-translate-y-1" : ""} border border-slate-200/50 dark:border-slate-700/50 hover:border-violet-300/50 dark:hover:border-violet-700/50 relative overflow-hidden ${onClick ? "cursor-pointer" : ""}`}
...
// Update ChartCard component to match admin dashboard style
