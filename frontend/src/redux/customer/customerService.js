...
const API_URL = "http://logisphere-backend-k9dz.onrender.com/api/customer"; // Adjust API URL if needed
...
export const getCustomerOrders = async () => {
  "customer/fetchOrders",
    ...
    try {
      const response = await fetch("http://logisphere-backend-k9dz.onrender.com/api/customer/orders", {
        method: "GET",
