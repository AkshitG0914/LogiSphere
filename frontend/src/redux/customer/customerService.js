...
const API_URL = "process.env.REACT_APP_API_URL/api/customer"; // Adjust API URL if needed
...
export const getCustomerOrders = async () => {
  "customer/fetchOrders",
    ...
    try {
      const response = await fetch("process.env.REACT_APP_API_URL/api/customer/orders", {
        method: "GET",
