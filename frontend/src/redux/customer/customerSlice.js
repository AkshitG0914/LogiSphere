...
export const fetchCustomerOrders = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      const response = await axios.get("process.env.REACT_APP_API_URL/api/orders/user", config);
...
export const fetchOrderTracking = createAsyncThunk(
  ...
  async (trackingId, thunkAPI) => {
    try {
      ...
      const response = await axios.get(`process.env.REACT_APP_API_URL/api/orders/track/${trackingId}`, config);
...
export const updateCustomerProfile = createAsyncThunk(
  ...
  async (userData, thunkAPI) => {
    try {
      ...
      const response = await axios.put("process.env.REACT_APP_API_URL/api/customer/profile", userData, config);
