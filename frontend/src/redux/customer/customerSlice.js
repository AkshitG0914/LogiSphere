...
export const fetchCustomerOrders = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      const response = await axios.get("http://logisphere-backend-k9dz.onrender.com/api/orders/user", config);
...
export const fetchOrderTracking = createAsyncThunk(
  ...
  async (trackingId, thunkAPI) => {
    try {
      ...
      const response = await axios.get(`http://logisphere-backend-k9dz.onrender.com/api/orders/track/${trackingId}`, config);
...
export const updateCustomerProfile = createAsyncThunk(
  ...
  async (userData, thunkAPI) => {
    try {
      ...
      const response = await axios.put("http://logisphere-backend-k9dz.onrender.com/api/customer/profile", userData, config);
